...
class FileNameParser():
    ...
    def baseParse(self, filePath):
        ...
        upperDir2 = os.path.split(fileDir)[1]
        (fileDir, upperDir3) = os.path.split(os.path.split(fileDir)[0])
        upperDir4 = os.path.split(fileDir)[1]
        ...
        self.upperDir2 = upperDir2
        self.upperDir3 = upperDir3
        self.upperDir4 = upperDir4

        self.Log("baseParse - uppderDir4: " + upperDir4)
        self.Log("baseParse - uppderDir3: " + upperDir3)
        self.Log("baseParse - uppderDir2: " + upperDir2)
